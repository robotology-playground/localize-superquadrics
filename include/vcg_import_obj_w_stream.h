            ...
            public:
                ...
                */
                static int Open( OpenMeshType &m, const char * filename, Info &oi)
                {
                    ...
                    int result = OpenStream(m, stream, oi);
                ...
                * \param oi       A structure containing infos about the object to be opened
                */
                static int OpenStream( OpenMeshType &m, std::istream &stream, Info &oi)
                {
                    ...
                    if (oi.mask == 0)
                        LoadMaskFromStream(stream, oi);

                    // since LoadMaskFromStream already consumed the stream
                    // rewind is required
                    stream.clear();
                    stream.seekg(0);
                ...
                */
                inline static void TokenizeNextLine(std::istream &stream, std::vector< std::string > &tokens, std::vector<Color4b> *colVec)
                {
                ...
                */
                ...
                /*     bool result = LoadMaskFromStream(stream, oi); */
                ...
                */
                ...
                static bool LoadMaskFromStream(std::istream &stream, Info &oi)
                {
